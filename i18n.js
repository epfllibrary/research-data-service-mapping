(function () {
  ...
  const TRANSLATIONS = {
    fr: {
      ...
      "header.logo.aria":          "Retour à l'accueil",
      ...
      "suggest.modal.intro": "Décrivez le service à ajouter. Un e-mail pré-rempli sera préparé pour l'équipe RDM, merci de ne pas le modifier.",
      ...
      "suggest.error.required": "Merci de remplir tous les champs obligatoires (*) : nom, unité, contact, phase(s), URL, bureau et description.",
      ...
      "detail.nav.aria": "Navigation entre services",
      "detail.prev.aria": "Service précédent",
      "detail.next.aria": "Service suivant",
      ...
      // Cluster bar
      "cluster.same.location": "Emplacements différents",
    ...
    en: {
      ...
      "suggest.modal.intro": "Describe the service to add. A pre-filled e-mail will be prepared for the RDM team, please don't modify it.",
      ...
      "suggest.error.required": "Please fill in all required fields (*): name, unit, contact, phase(s), URL, office, and description.",
      ...
      "detail.nav.aria": "Service navigation",
      "detail.prev.aria": "Previous service",
      "detail.next.aria": "Next service",
      ...
      // Cluster bar
      "cluster.same.location": "Different locations",
    ...
    de: {
      ...
      "header.logo.aria": "Zurück zur Startseite",
      ...
      "suggest.modal.intro": "Beschreiben Sie den hinzuzufügenden Dienst. Es wird eine vorausgefüllte E-Mail für das RDM-Team erstellt, bitte ändern Sie sie nicht.",
      ...
      "suggest.error.required": "Bitte füllen Sie alle Pflichtfelder (*) aus: Name, Einheit, Kontakt, Phase(n), URL, Büro und Beschreibung.",
      ...
      "detail.nav.aria": "Dienstnavigation",
      "detail.prev.aria": "Vorheriger Dienst",
      "detail.next.aria": "Nächster Dienst",
      ...
      "cluster.same.location": "Verschiedene Standorte",
    ...
    it: {
      ...
      "header.logo.aria": "Torna alla home",
      ...
      "suggest.modal.intro": "Descrivi il servizio da aggiungere. Verrà preparata un'e-mail precompilata per il team RDM, per favore non modificarla.",
      ...
      "suggest.error.required": "Compila tutti i campi obbligatori (*): nome, unità, contatto, fase/i, URL, ufficio e descrizione.",
      ...
      "detail.nav.aria": "Navigazione servizi",
      "detail.prev.aria": "Servizio precedente",
      "detail.next.aria": "Servizio successivo",
      ...
      "cluster.same.location": "Posizioni diverse",
      "offscreen.tip.n": "nord",
      "offscreen.tip.ne": "nord-est",
      "offscreen.tip.e": "est",
      "offscreen.tip.se": "sud-est",
